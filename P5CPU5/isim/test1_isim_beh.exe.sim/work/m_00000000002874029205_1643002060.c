...
#endif
static const char *ng0 = "E:/ISEproject/P5CPU5/mux.v";
...
LAB34:    t492 = (t0 + 3832);
    ...
    t498 = t497;
    t499 = (t3 + 4);
    t500 = *((unsigned int *)t3);
    t497 = (t497 & t500);
    t501 = *((unsigned int *)t499);
    t498 = (t498 & t501);
    t502 = (t496 + 4);
    t503 = *((unsigned int *)t496);
    *((unsigned int *)t496) = (t503 | t497);
    t504 = *((unsigned int *)t502);
    *((unsigned int *)t502) = (t504 | t498);
    xsi_driver_vfirst_trans(t492, 0, 0);
    t505 = (t0 + 3736);
    *((int *)t505) = 1;
...
LAB75:    if (*((unsigned int *)t253) != 0)
        goto LAB76;

LAB77:    t260 = (t146 + 4);
    t261 = *((unsigned int *)t146);
    t262 = *((unsigned int *)t260);
    t263 = (t261 || t262);
    if (t263 > 0)
        goto LAB78;

LAB79:    t265 = *((unsigned int *)t146);
    t266 = (~(t265));
...
LAB81:    if (*((unsigned int *)t260) > 0)
        goto LAB82;

LAB83:    if (*((unsigned int *)t146) > 0)
        goto LAB84;

LAB85:    memcpy(t145, t269, 8);

LAB86:    goto LAB46;

LAB47:    xsi_vlog_unsigned_bit_combine(t100, 32, t140, 32, t145, 32);
    goto LAB51;

LAB49:    memcpy(t100, t140, 8);
    goto LAB51;
...
LAB98:    if (*((unsigned int *)t305) > 0)
        goto LAB99;

LAB100:    if (*((unsigned int *)t270) > 0)
        goto LAB101;

LAB102:    memcpy(t269, t314, 8);

LAB103:    goto LAB81;

LAB82:    xsi_vlog_unsigned_bit_combine(t145, 32, t264, 32, t269, 32);
    goto LAB86;

LAB84:    memcpy(t145, t264, 8);
    goto LAB86;
...
LAB113:    memcpy(t390, t343, 8);

LAB114:    memset(t422, 0, 8);
    t423 = (t390 + 4);
...
LAB131:    memcpy(t443, t422, 8);

LAB132:    memset(t315, 0, 8);
    t475 = (t443 + 4);
...
LAB141:    if (*((unsigned int *)t475) != 0)
        goto LAB142;

LAB143:    t482 = (t315 + 4);
    t483 = *((unsigned int *)t315);
    t484 = *((unsigned int *)t482);
    t485 = (t483 || t484);
    if (t485 > 0)
        goto LAB144;

LAB145:    t487 = *((unsigned int *)t315);
    t488 = (~(t487));
...
LAB147:    if (*((unsigned int *)t482) > 0)
        goto LAB148;

LAB149:    if (*((unsigned int *)t315) > 0)
        goto LAB150;

LAB151:    memcpy(t314, t491, 8);

LAB152:    goto LAB98;

LAB99:    xsi_vlog_unsigned_bit_combine(t269, 32, t309, 32, t314, 32);
    goto LAB103;

LAB101:    memcpy(t269, t309, 8);
    goto LAB103;
...
LAB116:    *((unsigned int *)t366) = 1;

LAB118:    memset(t382, 0, 8);
    t383 = (t366 + 4);
...
LAB144:    t486 = ((char*)((ng2)));
    goto LAB145;

LAB146:    t491 = ((char*)((ng9)));
    goto LAB147;

LAB148:    xsi_vlog_unsigned_bit_combine(t314, 32, t486, 32, t491, 32);
    goto LAB152;

LAB150:    memcpy(t314, t486, 8);
    goto LAB152;
...
extern void work_m_00000000002874029205_1643002060_init()
{
	static char *pe[] = {(void *)Cont_127_0,(void *)Cont_134_1};
	xsi_register_didat("work_m_00000000002874029205_1643002060", "isim/test1_isim_beh.exe.sim/work/m_00000000002874029205_1643002060.didat");
