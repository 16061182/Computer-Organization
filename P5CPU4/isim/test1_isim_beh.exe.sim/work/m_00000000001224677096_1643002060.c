...
#endif
static const char *ng0 = "E:/ISEproject/P5CPU4/mux.v";
...
LAB113:    memcpy(t364, t343, 8);

LAB114:    memset(t315, 0, 8);
    t396 = (t364 + 4);
...
LAB123:    if (*((unsigned int *)t396) != 0)
        goto LAB124;

LAB125:    t403 = (t315 + 4);
    t404 = *((unsigned int *)t315);
    t405 = *((unsigned int *)t403);
    t406 = (t404 || t405);
    if (t406 > 0)
        goto LAB126;

LAB127:    t408 = *((unsigned int *)t315);
    t409 = (~(t408));
...
LAB131:    if (*((unsigned int *)t315) > 0)
        goto LAB132;

LAB133:    memcpy(t314, t412, 8);
...
LAB126:    t407 = ((char*)((ng2)));
    goto LAB127;

LAB128:    t412 = ((char*)((ng8)));
    goto LAB129;

LAB130:    xsi_vlog_unsigned_bit_combine(t314, 32, t407, 32, t412, 32);
    goto LAB134;

LAB132:    memcpy(t314, t407, 8);
    goto LAB134;
...
extern void work_m_00000000001224677096_1643002060_init()
{
	static char *pe[] = {(void *)Cont_120_0,(void *)Cont_127_1};
	xsi_register_didat("work_m_00000000001224677096_1643002060", "isim/test1_isim_beh.exe.sim/work/m_00000000001224677096_1643002060.didat");
