...
#endif
static const char *ng0 = "E:/ISEproject/P6CPU4/alu.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {2, 0};
static int ng4[] = {3, 0};
...
LAB20:    t719 = (t0 + 3088);
    ...
    t723 = *((char **)t722);
    memcpy(t723, t3, 8);
    xsi_driver_vfirst_trans(t719, 0, 31);
    t724 = (t0 + 3008);
    *((int *)t724) = 1;
...
LAB96:    *((unsigned int *)t263) = 1;

LAB98:    memset(t260, 0, 8);
    t279 = (t263 + 4);
...
LAB106:    if (*((unsigned int *)t286) > 0)
        goto LAB107;

LAB108:    if (*((unsigned int *)t260) > 0)
        goto LAB109;

LAB110:    memcpy(t259, t306, 8);
...
LAB125:    if (*((unsigned int *)t307) > 0)
        goto LAB126;

LAB127:    memcpy(t306, t353, 8);

LAB128:    goto LAB106;

LAB107:    xsi_vlog_unsigned_bit_combine(t259, 32, t301, 32, t306, 32);
    goto LAB111;

LAB109:    memcpy(t259, t301, 8);
    goto LAB111;
...
LAB130:    *((unsigned int *)t357) = 1;

LAB132:    memset(t354, 0, 8);
    t373 = (t357 + 4);
...
LAB140:    if (*((unsigned int *)t380) > 0)
        goto LAB141;

LAB142:    if (*((unsigned int *)t354) > 0)
        goto LAB143;

LAB144:    memcpy(t353, t402, 8);

LAB145:    goto LAB123;

LAB124:    xsi_vlog_unsigned_bit_combine(t306, 32, t348, 32, t353, 32);
    goto LAB128;

LAB126:    memcpy(t306, t348, 8);
    goto LAB128;
...
LAB137:    t386 = (t0 + 1208U);
    ...
    *((unsigned int *)t388) = t392;
    ...
    t394 = (t393 >> 0);
    *((unsigned int *)t386) = t394;
    t395 = *((unsigned int *)t388);
    *((unsigned int *)t388) = (t395 & 31U);
    t396 = *((unsigned int *)t386);
    *((unsigned int *)t386) = (t396 & 31U);
    memset(t397, 0, 8);
    xsi_vlog_signed_arith_rshift(t397, 32, t387, 32, t388, 5);
    goto LAB138;

LAB139:    t404 = (t0 + 1368U);
    t405 = *((char **)t404);
    t404 = ((char*)((ng10)));
    memset(t406, 0, 8);
    t407 = (t405 + 4);
...
LAB147:    *((unsigned int *)t406) = 1;

LAB149:    memset(t403, 0, 8);
    t422 = (t406 + 4);
...
LAB157:    if (*((unsigned int *)t429) > 0)
        goto LAB158;

LAB159:    if (*((unsigned int *)t403) > 0)
        goto LAB160;

LAB161:    memcpy(t402, t453, 8);

LAB162:    goto LAB140;

LAB141:    xsi_vlog_unsigned_bit_combine(t353, 32, t397, 32, t402, 32);
    goto LAB145;

LAB143:    memcpy(t353, t397, 8);
    goto LAB145;
...
LAB167:    *((unsigned int *)t457) = 1;

LAB169:    memset(t454, 0, 8);
    t473 = (t457 + 4);
...
LAB177:    if (*((unsigned int *)t480) > 0)
        goto LAB178;

LAB179:    if (*((unsigned int *)t454) > 0)
        goto LAB180;

LAB181:    memcpy(t453, t529, 8);

LAB182:    goto LAB157;

LAB158:    xsi_vlog_unsigned_bit_combine(t402, 32, t436, 32, t453, 32);
    goto LAB162;

LAB160:    memcpy(t402, t436, 8);
    goto LAB162;

LAB163:    t447 = *((unsigned int *)t436);
...
LAB189:    *((unsigned int *)t533) = 1;

LAB191:    memset(t549, 0, 8);
    t550 = (t533 + 4);
...
LAB197:    memcpy(t574, t549, 8);

LAB198:    memset(t530, 0, 8);
    t606 = (t574 + 4);
...
LAB209:    t613 = (t530 + 4);
    t614 = *((unsigned int *)t530);
    t615 = *((unsigned int *)t613);
    t616 = (t614 || t615);
    if (t616 > 0)
        goto LAB210;

LAB211:    t618 = *((unsigned int *)t530);
    t619 = (~(t618));
...
LAB213:    if (*((unsigned int *)t613) > 0)
        goto LAB214;

LAB215:    if (*((unsigned int *)t530) > 0)
        goto LAB216;

LAB217:    memcpy(t529, t622, 8);

LAB218:    goto LAB177;

LAB178:    xsi_vlog_unsigned_bit_combine(t453, 32, t484, 32, t529, 32);
    goto LAB182;

LAB180:    memcpy(t453, t484, 8);
    goto LAB182;

LAB183:    t499 = *((unsigned int *)t488);
...
LAB196:    t562 = (t0 + 1048U);
    t563 = *((char **)t562);
    t562 = (t0 + 1208U);
    t565 = *((char **)t562);
    memset(t566, 0, 8);
    xsi_vlog_signed_less(t566, 32, t563, 32, t565, 32);
    memset(t567, 0, 8);
    t562 = (t566 + 4);
...
LAB200:    if (*((unsigned int *)t562) != 0)
        goto LAB201;

LAB202:    t575 = *((unsigned int *)t549);
...
LAB203:    t586 = *((unsigned int *)t574);
    t587 = *((unsigned int *)t580);
    *((unsigned int *)t574) = (t586 | t587);
    t588 = (t549 + 4);
    t589 = (t567 + 4);
    t590 = *((unsigned int *)t549);
    t591 = (~(t590));
...
LAB210:    t617 = ((char*)((ng2)));
    goto LAB211;

LAB212:    t624 = (t0 + 1368U);
    t625 = *((char **)t624);
    t624 = ((char*)((ng13)));
    memset(t626, 0, 8);
    t627 = (t625 + 4);
...
LAB220:    *((unsigned int *)t626) = 1;

LAB222:    memset(t642, 0, 8);
    t643 = (t626 + 4);
...
LAB228:    memcpy(t670, t642, 8);

LAB229:    memset(t623, 0, 8);
    t702 = (t670 + 4);
    t703 = *((unsigned int *)t702);
    t704 = (~(t703));
    t705 = *((unsigned int *)t670);
    t706 = (t705 & t704);
    t707 = (t706 & 1U);
    if (t707 != 0)
        goto LAB242;

LAB243:    if (*((unsigned int *)t702) != 0)
        goto LAB244;
...
LAB249:    if (*((unsigned int *)t709) > 0)
        goto LAB250;

LAB251:    if (*((unsigned int *)t623) > 0)
        goto LAB252;

LAB253:    memcpy(t622, t718, 8);

LAB254:    goto LAB213;

LAB214:    xsi_vlog_unsigned_bit_combine(t529, 32, t617, 32, t622, 32);
    goto LAB218;

LAB216:    memcpy(t529, t617, 8);
    goto LAB218;
...
LAB234:    if (*((unsigned int *)t656) < *((unsigned int *)t658))
        goto LAB232;

LAB233:    memset(t662, 0, 8);
    t663 = (t659 + 4);
...
LAB236:    if (*((unsigned int *)t663) != 0)
        goto LAB237;

LAB238:    t671 = *((unsigned int *)t642);
...
LAB232:    *((unsigned int *)t659) = 1;
    goto LAB233;

LAB235:    *((unsigned int *)t662) = 1;
    goto LAB238;
...
LAB239:    t682 = *((unsigned int *)t670);
    t683 = *((unsigned int *)t676);
    *((unsigned int *)t670) = (t682 | t683);
    t684 = (t642 + 4);
    t685 = (t662 + 4);
    t686 = *((unsigned int *)t642);
    t687 = (~(t686));
...
LAB246:    t713 = ((char*)((ng2)));
    goto LAB247;

LAB248:    t718 = ((char*)((ng1)));
    goto LAB249;

LAB250:    xsi_vlog_unsigned_bit_combine(t622, 32, t713, 32, t718, 32);
    goto LAB254;

LAB252:    memcpy(t622, t713, 8);
    goto LAB254;

}


extern void work_m_00000000002590012398_2725559894_init()
{
	static char *pe[] = {(void *)Cont_28_0};
	xsi_register_didat("work_m_00000000002590012398_2725559894", "isim/test1_isim_beh.exe.sim/work/m_00000000002590012398_2725559894.didat");
